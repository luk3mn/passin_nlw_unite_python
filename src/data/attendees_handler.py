...
class AttendeesHandler:
    ...
    def registry(self, http_request: HttpRequest) -> HttpResponse:
        ...
        self.__attendees_repository.insert_attendeee(body)
    ...
    def find_attendee_badge(self, http_request: HttpRequest) -> HttpResponse:
        ...
        if not badge: raise HttpNotFoundError("Attendee has not found!")
    ...
    def find_attendees_from_events(self, http_request: HttpRequest) -> HttpResponse:
        ...
        if not attendees: raise HttpNotFoundError("Attendees has not found")
